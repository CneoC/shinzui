...
void DebugFont::load(const char *file, int height)
{
	assert(!m_pTextures);
...
void DebugFont::print(const Vector2f &p, size_t length, const char *text) const
{
...
void DebugFont::printf(const Vector2f &p, const char *fmt, ...) const
{
	assert(fmt);
...
void DebugFont::createDisplayList(FT_Face face, unsigned char c)
{
