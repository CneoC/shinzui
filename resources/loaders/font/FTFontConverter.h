...
#ifndef __RESOUCRES_LOADERS_FONT_FTFONTCONVERTER_H__
#define __RESOUCRES_LOADERS_FONT_FTFONTCONVERTER_H__
...
class FTFontConverter
	: public ResourceLoaderBase
{
public:
	/**
	 * Constructs a freetype2 font converter
	 */
	FTFontConverter()
	{
	}
...
#endif //__RESOUCRES_LOADERS_FONT_FTFONTCONVERTER_H__
